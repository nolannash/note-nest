export default function Home() {
  return (
    <div className="inline-grid grid-cols-3 w-full h-full flex-wrap justify-items items-center divide-x divide-solid divide-white text-center text-lg resize-x">
      <div className='h-full resize-x'>
      ...
      <div className='h-full hover:resize-x'> 
